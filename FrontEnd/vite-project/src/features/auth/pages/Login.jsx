...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#0d0d0f] text-white px-4 py-10 overflow-hidden">
      ...
      >
        <div className="text-center field-enter pt-5 " style={{ animationDelay: "0.05s" }}>
          ...
          <p className="text-[#7e7e94] text-sm mt-2">Log in to continue</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 p-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="btn-glow field-enter mt-2 bg-gradient-to-br from-[#e0485a] to-[#b83048] hover:opacity-90 disabled:opacity-60 text-white  rounded font-semibold py-3 rounded-full transition-all duration-200 text-sm shadow-[0_4px_24px_#e0485a33] hover:scale-[1.02] active:scale-[0.98]"
        ...
        >
          ...
          <Link to={"/Register"} className=" hover:underline font-medium  " style={{color:"#e0485a"}}>
            Register
          </Link>
        </p>
      </div>
